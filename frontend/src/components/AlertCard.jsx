export default function AlertCard({ alert, onClick, darkMode }) {
  ...
  return (
    <div
      ...
      className={`group relative cursor-pointer rounded-3xl overflow-hidden border border-white/20 dark:border-white/10 transition-all duration-500 ease-out
        ...
        ${cardBg} ${cardBorder}
        ${alert.acked 
          ? (darkMode ? 'opacity-60 hover:opacity-80' : 'opacity-70 hover:opacity-90')
          : ''
        }
    ...
    >
      ...
      <div className="p-6 pl-8 flex flex-col h-full min-h-[220px]">
        {/* HEADER: Status + Tecnología | Fecha */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            {isFiring ? (
              ...
              <span className="inline-flex items-center px-4 py-2 rounded-2xl ring-2 ring-white/30 text-xs font-bold bg-gradient-to-r from-green-600 to-green-700 text-white shadow-lg shadow-green-500/30">
        ...
        <div className="mb-4 flex-grow">
          ...
          <p className={`text-sm leading-relaxed ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            {alert.summary || alert.labels?.summary || alert.annotations?.summary || 'Sin descripción'}
          </p>
        </div>
